package com.boffincoder.java8.methodref;
...
public class MethodReferenceExample {
	...
	private static void staticMethodReference() {
		...
		List<Employee> employees = Arrays.asList(new Employee("Amandeep", "Singh", 27),
	...
	private static void instanceMethodReferenceOfArbitraryObject() {
		...
		List<String> values = Arrays.asList("Amandeep", "Sunil", "Anil", "Rajesh", "sajjad");
	...
	private static void instanceMethodReference() {
		...
		List<User> users = Arrays.asList(new User("Amandeep", "Singh"),
